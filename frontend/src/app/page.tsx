    ...
    <AnimatePresence mode="wait">
      ...
      >
        <section className="text-center my-6 px-4 sm:px-8">
          ...
          >
            Practice real-time interviews with professional experts and boost your confidence.
          </motion.p>
        ...
        <section className="px-5 sm:px-12 py-6">
          <h2 className="text-2xl sm:text-3xl font-medium text-left pb-4">Why Interview Skills Matter</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-lg sm:text-xl font-medium">{feature.description}</p>
              </motion.div>
            ))}
          </div>
        </section>
        <section className="px-5 sm:px-12 py-6">
          <h2 className="text-2xl sm:text-3xl font-medium text-left pb-4">Our Expert Interviewers</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {expertsOpinion.map((expert, index) => (
              ...
              >
                ...
                />
                <h3 className="text-2xl sm:text-3xl font-bold">{expert.expertName}</h3>
        ...
        <section className="px-5 sm:px-12 py-6">
          <h2 className="text-2xl sm:text-3xl font-medium text-left pb-4">Success Stories</h2>
            ...
            {successStories.map((user, index) => (
              ...
              >
                <Image
                  ...
                  className="rounded-full mx-auto mb-4"
                />
                <h3 className="text-2xl sm:text-3xl font-bold">{user.userName}</h3>
        ...
        <section className="flex flex-col sm:flex-row items-center justify-between px-5 sm:px-12 py-6 gap-6">
          <h2 className="text-2xl sm:text-3xl font-medium pb-4 sm:pb-0">Ready to Ace Your Next Interview?</h2>
